...
export default function IntroductionPage() {
  return (
    <GuideDocsPage
      ...
      description={introductionTagline}
    ...
    >
      <div className={guidePageBodyClassName}>
        <PageReveal inView>
          <p>
            {SITE.NAME} is a curated collection of reusable UI delivered through
            the shadcn registry workflow. The focus is minimalism: restrained
            motion and familiar interaction patterns that help teams ship
            interfaces users already know how to read.
          </p>
        </PageReveal>

        <PageReveal inView>
          <section className={docsPageSectionClassName} id="philosophy">
            <h2 className={docsPageSectionTitleClassName}>Philosophy</h2>
            <p>
              Great component libraries do more than save time. They set a
              baseline — how much visual noise is acceptable, how interactions
              should feel, and whether the product stays coherent as it grows.
            </p>
            <p>
              {SITE.NAME} is intentionally minimal. Motion is present, but never
              decorative. Every transition confirms an action, orients the user,
              or preserves spatial context — not performs. That restraint keeps
              interfaces feeling standard: predictable, calm, and aligned with
              patterns people already know from well-made products.
            </p>
            <p>
              When teams evaluate a UI library, they usually ask themselves a
            ...
            <ul className={docsPageListClassName}>
              ...
              <li>
                Do the interactions feel dependable without teaching users a new
                language?
              </li>
            </ul>
            <p>
              {SITE.NAME} is built around a simple answer: quality lives in
              clarity, not complexity. Components arrive as local files, so
              motion, styling, structure, and accessibility can evolve inside
              your own codebase instead of behind a package boundary.
            </p>
            <p>
              That approach keeps adoption practical. You can review the
              implementation, adjust details to match your product, and keep
              moving without waiting on an upstream release cycle.
            </p>
          </section>
        </PageReveal>
        ...
        <PageReveal inView>
          <section className={docsPageSectionClassName} id="community">
            ...
            <p>
              ...
              products. If you want to follow updates, inspect the source, or
              support the project, these are the best places to start.
            </p>

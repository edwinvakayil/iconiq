...
export default function IconLibraryPage() {
  ...
  return (
    <DocsPageShell
      ...
      description="Browse every Iconiq icon in a cleaner library view. Each icon is copy-paste ready, motion-aware, and designed to sit comfortably beside Lucide."
      eyebrow="Animated Icon Library"
      meta={[
        { label: "Count", value: `${icons.length}+ icons` },
        { label: "Format", value: "Registry-ready React components" },
        { label: "System", value: "Lucide-aligned motion geometry" },
      ]}
      title="Icon Library"
    >
      <DocsSection
        className="lg:col-span-12"
        description="Search by name or keyword, then open any icon detail page to copy its install command and explore related glyphs."
        index="01"
        title="Browse"
      >

        ...
        <div className="mx-auto max-w-[720px] px-4 py-10 sm:px-6 sm:py-12">
          ...
          <section id="overview" className="scroll-mt-24">
            ...
            <div className="mt-10 space-y-4 font-sans text-sm leading-relaxed text-neutral-600">
              <p>
              Iconiq is a collection of animated icons built with Motion and based on the Lucide icon system. 
              Each icon is designed for modern interfaces, combining clean visuals with subtle motion.
              </p>
              <p>
              Icons are copy-paste React components, 
              so you can integrate them directly into your codebase and customize them freely.
              </p>
              <p>

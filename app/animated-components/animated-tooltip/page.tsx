  ...
  <button type="button">Hover me</button>
              ...
              >
                ...
                <p className="font-sans text-neutral-600 text-sm">
                  ...
                  quickly integrate the component or experiment with different UI
                  implementations.
                </p>
          ...
          <div className="mt-6 border-t border-neutral-200 pt-4 text-sm dark:border-neutral-800">
            ...
            <dl className="mt-3 divide-y divide-neutral-200 border border-neutral-200 text-[13px] dark:divide-neutral-800 dark:border-neutral-800">
              ...
              <div className="grid grid-cols-[minmax(0,140px)_minmax(0,1fr)] gap-x-4 px-3 py-2.5">
                ...
                <dd className="text-neutral-600 dark:text-neutral-300">
                  Tooltip content (<code className="rounded bg-neutral-200 px-1 font-mono text-[11px] dark:bg-neutral-700 dark:text-neutral-200">ReactNode</code>).
                </dd>
              </div>
              <div className="grid grid-cols-[minmax(0,140px)_minmax(0,1fr)] gap-x-4 px-3 py-2.5">
                <dt className="font-mono text-xs text-neutral-900 dark:text-neutral-100">

      ...
      <main className="min-w-0 flex-1">
        <div className="mx-auto max-w-[720px] px-4 py-10 sm:px-6 sm:py-12">
          ...
          <p className="mt-2 font-sans text-lg text-neutral-600 leading-relaxed dark:text-neutral-300">
            An animated radio group with staggered entrance, hover and tap
            feedback, and a shimmer on the selected option. Built with Radix UI
            and Framer Motion.
          </p>

          <p className="mt-6 font-sans text-neutral-600 text-sm leading-relaxed dark:text-neutral-300">
            Use it for single-choice options like plan selection or preferences.
            Each item can have a label and optional description. The selected
            item shows a subtle shimmer and a pulsing ring.
          </p>

          <div className="mt-10">
            <CodeBlockInstall componentName="radiogroup" />
          </div>
          ...
          <div className="mt-10 rounded-sm border border-neutral-200 bg-neutral-50/80 p-4 shadow-[0_18px_45px_rgba(15,23,42,0.06)] backdrop-blur-sm sm:p-6 dark:border-neutral-800 dark:bg-neutral-900/70 dark:shadow-[0_18px_45px_rgba(15,23,42,0.7)]">
            <Tabs
              aria-label="Radio Group preview, code, and get the component"
              className="w-full"
            ...
            >
              ...
              >
                <p className="font-sans text-neutral-600 text-sm dark:text-neutral-400">
                  Select an option to see the shimmer and ping on the chosen
                  item. Hover and tap for scale feedback.
                </p>
              ...
              >
                ...
                <p className="font-sans text-neutral-600 text-sm dark:text-neutral-400">
                  ...
                  . Use standard Radix props such as{" "}
                  <code className="rounded bg-neutral-200 px-1 font-mono text-xs dark:bg-neutral-700 dark:text-neutral-200">
                    defaultValue
                  </code>
                  ,{" "}
                ...
                <div className="mt-4">
                  <CodeBlock
                    code={`import { AnimatedRadioGroup, AnimatedRadioGroupItem } from "@/components/ui/radiogroup";
    ...
    <AnimatedRadioGroup defaultValue="pro" name="plan">
      ...
      />
              ...
              >
                ...
                <div className="mt-6">
                  <ComponentActions name="radiogroup" />
                </div>
              </TabsContent>
            </Tabs>
          </div>

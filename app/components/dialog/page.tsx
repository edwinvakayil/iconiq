...
const componentDetailsItems: DetailRow[] = [
  ...
  {
    id: "primitives",
    title: "DialogHeader, Title, Description, Footer",
    content:
  ...
  },
  {
    id: "lucide-react",
    title: "lucide-react",
    content: "Close affordance uses the X icon with a small hover rotation.",
  },
  {
    id: "registry",
      ...
      <div className="mx-auto w-full max-w-screen-2xl px-4 py-10 sm:px-6 sm:py-12 lg:px-10">
        ...
        >
          ...
          <p className="mt-2 font-sans text-[15px] text-neutral-500 leading-relaxed dark:text-neutral-400">
            Accessible modal on Radix Dialog with Framer Motion overlay and
            content transitions, plus a staggered inner layout.
          </p>
        </motion.header>
        ...
        >
          ...
          >
            ...
            <div className="min-w-0 flex-1 [&>div]:mt-0">
              <CodeBlockInstall componentName="dialog" />
            </div>
          </BentoMotion>
          ...
          >
            ...
            <p className="mb-5 flex-1 font-sans text-neutral-500 text-sm leading-snug dark:text-neutral-400">
              Ship the registry bundle to v0 and tweak motion or layout with
              prompts.
            </p>
            <ComponentActions name="dialog" />
          </BentoMotion>
          ...
          >
            ...
            <p className="mb-3 font-sans text-neutral-500 text-xs leading-snug dark:text-neutral-400">
              API surface and packages — same pattern as other Iconiq registry
              components.
            </p>

        ...
        <div className="mx-auto max-w-[720px] px-4 py-10 sm:px-6 sm:py-12">
          ...
          >
            <ol className="flex items-center gap-1.5 font-sans text-neutral-500 text-sm">
              ...
              <li
                aria-current="page"
                className="w-[140px] truncate text-neutral-900 sm:w-auto"
              >
          ...
          <p className="mt-2 font-sans text-lg text-neutral-600 leading-relaxed dark:text-neutral-400">
            A floating banner that summarizes incoming access requests and
            expands into an inline list with approve and reject actions.
          </p>

          <p className="mt-6 font-sans text-neutral-600 text-sm leading-relaxed dark:text-neutral-400">
            Use this pattern to surface workspace, project, or file access
            requests without disrupting the main UI, while still giving users a
            quick way to review who&apos;s asking for access.
          </p>

          <div className="mt-10">
            <CodeBlockInstall componentName="accessrequest" />
          </div>
          ...
          <div className="mt-10 rounded-sm border border-neutral-200 bg-neutral-50/80 p-4 shadow-[0_18px_45px_rgba(15,23,42,0.06)] backdrop-blur-sm sm:p-6 dark:border-neutral-800 dark:bg-neutral-900/70 dark:shadow-[0_18px_45px_rgba(15,23,42,0.7)]">
            <Tabs
              aria-label="Access Request Banner preview, code, and get the component"
              className="w-full"
            ...
            >
              ...
              >
                <p className="font-sans text-neutral-600 text-sm dark:text-neutral-400">
                  The banner appears at the top edge of its container. Click the
                  chevron to expand and review each requester, then approve or
                  reject inline. Use Reset to restore the demo state.
                </p>

                <AccessRequestPreviewBlock />
              </TabsContent>
              ...
              >
                ...
                <p className="font-sans text-neutral-600 text-sm dark:text-neutral-400">
                  Define your own list of access requests and pass them as{" "}
                  <code className="rounded bg-neutral-200 px-1 font-mono text-xs dark:bg-neutral-700 dark:text-neutral-200">
                    initialRequests
                  </code>{" "}
                  to the banner. The component manages expand / collapse and
...
`}
              ...
              >
                ...
                <div className="mt-6">
                  <ComponentActions name="accessrequest" />
                </div>
              </TabsContent>
            </Tabs>
          </div>
            ...
            <dl className="mt-3 divide-y divide-neutral-200 border border-neutral-200 text-[13px] dark:divide-neutral-800 dark:border-neutral-800">
              <div className="grid grid-cols-[minmax(0,150px)_minmax(0,1fr)] gap-x-4 px-3 py-2.5">
                ...
                <dd className="text-neutral-600 dark:text-neutral-300">
                  ...
                  objects used to seed the banner. If omitted, a demo list is
                  used.
                </dd>
              </div>
            </dl>

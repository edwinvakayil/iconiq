...
**IMPORTANT:** iconiqs only accepts contributions based on [Lucide icons](https://lucide.dev/). Pull requests containing custom icons or icons from other icon packs will be closed.
...
We welcome contributions to iconiqs! Please follow these steps to contribute:
...
2. Clone your forked repository to your local machine:
   ...
   ```bash
   git clone https://github.com/edwinvakayil/iconiqs.git
   ```
...
5. Install the project dependencies (iconiqs uses `pnpm`):

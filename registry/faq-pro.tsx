...
const faqProPanelClassName = cn(
  "overflow-hidden",
  "opacity-100 transition-[opacity] duration-[560ms] will-change-[opacity]",
  "data-closed:opacity-[0.999] data-ending-style:opacity-[0.999] data-starting-style:opacity-[0.999]"
);
  ...
  return (
    ...
    >
      <AccordionPrimitive.Header className="flex">
        <AccordionPrimitive.Trigger className="flex w-full items-start justify-between gap-4 px-5 py-4 text-left outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-inset">
      ...
      <AccordionPrimitive.Panel
        ...
        render={(renderProps, state) => {
          ...
          return (
            <div
              {...resolvedRenderProps}
              className={cn(faqProPanelClassName, renderClassName)}
              ref={renderRef}
            >
              <motion.div
        ...
        <AnimatePresence initial={false} mode="popLayout">
          {visibleItems.length > 0 ? (
            visibleItems.map((item) => (
              ...
              >
                <FaqProRow item={item} query={query} />
              </motion.div>
            ))
          ) : (
            <motion.p

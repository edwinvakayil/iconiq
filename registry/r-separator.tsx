...
> = {
  horizontal: {
    ...
    dashed:
      "h-px w-full bg-[length:8px_1px] bg-[linear-gradient(90deg,var(--ic-border)_0,var(--ic-border)_58%,transparent_58%,transparent_100%)] bg-repeat-x",
    dotted: "h-0 w-full border-border border-t border-dotted bg-transparent",
  },
  vertical: {
    line: "h-full min-h-4 w-px bg-border",
    dashed:
      "h-full min-h-4 w-px bg-[length:1px_8px] bg-[linear-gradient(180deg,var(--ic-border)_0,var(--ic-border)_58%,transparent_58%,transparent_100%)] bg-repeat-y",
    dotted:

...
function SelectOptionRow({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "group relative isolate flex min-h-11 cursor-pointer touch-manipulation select-none items-center gap-3 px-3 py-2.5 text-foreground text-sm outline-none transition-colors",
  ...
  return (
    ...
    >
      <motion.button
        ...
        className={cn(
          "flex min-h-11 w-full touch-manipulation items-center justify-between gap-2 border border-border bg-card px-4 py-3 text-left font-medium text-foreground text-sm transition-colors hover:bg-accent/60 focus:outline-none focus-visible:ring-2 focus-visible:ring-ring",
          controlCornerClassName
        )}
